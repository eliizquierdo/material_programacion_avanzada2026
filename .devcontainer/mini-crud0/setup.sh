...
#!/bin/bash
cd "/workspaces/material_programacion_avanzada2026/proyectos-teoricos/mini-crud0"

if [ -n "\$CODESPACE_NAME" ] && [ -n "\$GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN" ]; then
  URL="https://\${CODESPACE_NAME}-8080.\${GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN}/mini-crud0"
else
  URL="http://localhost:8080/mini-crud0"
fi
