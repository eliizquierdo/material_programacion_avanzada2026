...
PROJECT_DIR="/workspaces/material_programacion_avanzada2026/ejemplos-resueltos/primer-formulario-servlet"
DEVCONTAINER_DIR="/workspaces/material_programacion_avanzada2026/.devcontainer/primer-formulario-servlet"
TOMCAT_HOME="/opt/tomcat10"
CONTEXT_PATH="primer-formulario-servlet"

echo ""
echo "🚀 Configurando entorno Java Web — primer-formulario-servlet..."
echo ""
...
#!/bin/bash
cd "/workspaces/material_programacion_avanzada2026/ejemplos-resueltos/primer-formulario-servlet"

if [ -n "\$CODESPACE_NAME" ] && [ -n "\$GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN" ]; then
  URL="https://\${CODESPACE_NAME}-8080.\${GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN}/primer-formulario-servlet"
else
  URL="http://localhost:8080/primer-formulario-servlet"
fi
...
echo ""
echo "╔══════════════════════════════════════════════════════╗"
echo "║  ✅  Entorno listo — primer-formulario-servlet"
echo "╠══════════════════════════════════════════════════════╣"
