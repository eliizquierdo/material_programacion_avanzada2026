...
PROJECT_DIR="/workspaces/material_programacion_avanzada2026/ejemplos-resueltos/ejemplo-sesiones"
DEVCONTAINER_DIR="/workspaces/material_programacion_avanzada2026/.devcontainer/ejemplo-sesiones"
TOMCAT_HOME="/opt/tomcat10"
CONTEXT_PATH="ejemplo-sesiones"

echo ""
echo "🚀 Configurando entorno Java Web — ejemplo-sesiones..."
echo ""
...
#!/bin/bash
cd "/workspaces/material_programacion_avanzada2026/ejemplos-resueltos/ejemplo-sesiones"

if [ -n "\$CODESPACE_NAME" ] && [ -n "\$GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN" ]; then
  URL="https://\${CODESPACE_NAME}-8080.\${GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN}/ejemplo-sesiones"
else
  URL="http://localhost:8080/ejemplo-sesiones"
fi
...
echo ""
echo "╔══════════════════════════════════════════════════════╗"
echo "║  ✅  Entorno listo — ejemplo-sesiones"
echo "╠══════════════════════════════════════════════════════╣"
