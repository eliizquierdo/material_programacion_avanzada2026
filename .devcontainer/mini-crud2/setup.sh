...
PROJECT_DIR="/workspaces/material_programacion_avanzada2026/proyectos-teoricos/mini-crud2"
DEVCONTAINER_DIR="/workspaces/material_programacion_avanzada2026/.devcontainer/mini-crud2"
TOMCAT_HOME="/opt/tomcat10"
CONTEXT_PATH="mini-crud2"

echo ""
echo "🚀 Configurando entorno Java Web — mini-crud2..."
echo ""
...
#!/bin/bash
cd "/workspaces/material_programacion_avanzada2026/proyectos-teoricos/mini-crud2"

if [ -n "\$CODESPACE_NAME" ] && [ -n "\$GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN" ]; then
  URL="https://\${CODESPACE_NAME}-8080.\${GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN}/mini-crud2"
else
  URL="http://localhost:8080/mini-crud2"
fi
