...
PROJECT_DIR="/workspaces/material_programacion_avanzada2026/proyectos-teoricos/mini-crud-jsp"
DEVCONTAINER_DIR="/workspaces/material_programacion_avanzada2026/.devcontainer/mini-crud-jsp"
TOMCAT_HOME="/opt/tomcat10"
CONTEXT_PATH="mini-crud-jsp"

echo ""
echo "🚀 Configurando entorno Java Web — mini-crud-jsp..."
echo ""
...
#!/bin/bash
cd "/workspaces/material_programacion_avanzada2026/proyectos-teoricos/mini-crud-jsp"

if [ -n "\$CODESPACE_NAME" ] && [ -n "\$GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN" ]; then
  URL="https://\${CODESPACE_NAME}-8080.\${GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN}/mini-crud-jsp"
else
  URL="http://localhost:8080/mini-crud-jsp"
fi
...
echo ""
echo "╔══════════════════════════════════════════════════════╗"
echo "║  ✅  Entorno listo — mini-crud-jsp"
echo "╠══════════════════════════════════════════════════════╣"
