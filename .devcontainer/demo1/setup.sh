...
#!/bin/bash
cd "/workspaces/material_programacion_avanzada2026/ejemplos-resueltos/demo1"

if [ -n "\$CODESPACE_NAME" ] && [ -n "\$GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN" ]; then
  URL="https://\${CODESPACE_NAME}-8080.\${GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN}/demo1"
else
