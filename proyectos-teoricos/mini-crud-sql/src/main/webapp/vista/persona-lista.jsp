...
import="java.util.List" %> <%@ page import="modelo.vo.PersonaVO" %> <% String
baseURL = request.getContextPath(); List<PersonaVO>
  listaPersonas = (List<PersonaVO
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="actions">
                    ...
                    <!-- Botón Eliminar -->
                    <form
                      action="<%= baseURL %>/persona?action=eliminar"
                      method="post"
